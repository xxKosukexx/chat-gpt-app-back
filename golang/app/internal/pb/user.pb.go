...
var file_internal_proto_user_proto_rawDesc = []byte{
	...
	0x72, 0x22, 0x16, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x45, 0x6d, 0x61, 0x69,
	0x6c, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x2f, 0x0a, 0x15, 0x47, 0x65, 0x74,
	...
	0x28, 0x09, 0x52, 0x06, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x73, 0x32, 0x57, 0x0a, 0x0b, 0x55, 0x73,
	0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x48, 0x0a, 0x0d, 0x47, 0x65, 0x74,
	0x55, 0x73, 0x65, 0x72, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x73, 0x12, 0x1a, 0x2e, 0x75, 0x73, 0x65,
	0x72, 0x2e, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x73, 0x52,
...
var file_internal_proto_user_proto_goTypes = []interface{}{
	(*GetUserEmailsRequest)(nil),  // 0: user.GetUserEmailsRequest
	(*GetUserEmailsResponse)(nil), // 1: user.GetUserEmailsResponse
}
var file_internal_proto_user_proto_depIdxs = []int32{
	0, // 0: user.UserService.GetUserEmails:input_type -> user.GetUserEmailsRequest
	1, // 1: user.UserService.GetUserEmails:output_type -> user.GetUserEmailsResponse
...
func file_internal_proto_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_proto_user_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetUserEmailsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
